...
- Último despliegue: `dpl_DWLjwC3cWWbuMvVZfRCeKRE4Q5bj`, listo y aliasado en la URL estable.
- Versión publicada: `2.0.19`.
...
- Entrega `2.0.19` publicada y verificada en producción: filtro sencillo de facturación en Pedidos, relación persistente de facturas agrupadas y bloqueo de duplicados, además de las mejoras visuales anteriores.
